...
par(mfcol=c(2,2))
#subplot 1
plot(fine_data$DateTime, fine_data$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")
#subplot 2
...
#subplot 3
plot(fine_data$DateTime, fine_data$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
#subplot 4
plot(fine_data$DateTime, fine_data$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")
#closing session
dev.off()
